...
#define _OPT_CHK		0
#define _WLS_CHK		0
#define _NO_BUZ			0	/*  NO Buzzer */

#define _LOWBAT_MASK	1	/* 0  Low Bat. Check  */
#define _WLS_MASK		1	/* 0  WLS 수위센서 */

#define _SMT_DMSpeed	1	
#define _SMT_SPLAY		0	
...
#define _CURTIS			1	/* 조향 CURTIS */

//#define DRV_SPDTBNo		6
#define CONST_U2WATIME	2000	
...
/* PART A Define */
	...
	32	PA7 			
	67	PA8 	IN_Ready	
	68	PA9 	UART 1		TX	Debug				CON-04,  7
	69	PA10				RX						CON-04,  8
...
/* PORT E Define */
	...
	45	PE14	IN_PORT 	лSPEED OPTION	CON-01,  16 
...
#define Model_Name0		0xA0	
#define Model_Name1		0xA1	
#define Model_Name2		0xA2	
#define Model_Name3		0xA3	
#define Model_Name4		0xA4	
#define Model_Name5		0xA5	
#define Model_Name6		0xA6	
